...
:PROPERTIES:
:EXPORT_DATE: [2026-06-15 Tue 22:12]
...
#+begin_src gnuplot :var data=traffic-data :file ~/blog/static/images/blog-traffic.png :exports results
set title "Blog Traffic"
set xlabel "Day of Week"
set ylabel "Count"
set style data linespoints
plot data using 2:xtic(1) title "Views" linewidth 2, \
     data using 3:xtic(1) title "Visitors" linewidth 2
#+end_src

#+RESULTS:
[[/blog/images/blog-traffic.png]]

*** [[https://bladesinthedark.com/greetings-scoundrel][Blades In The Dark]]

{{{imgzoom}}}
#+attr_html: :width 50% :height 50%
[[/blog/images/bitd.png]]
...
*** [[https://shop.arcdream.com/products/delta-green-the-role-playing-game-hardback-slipcase-set?ref=delta-green.com][Delta Green]] :noexport:
{{{imgzoom}}}
...
*** Draw Steel :noexport:
{{{imgzoom}}}
file:/blog/images/draw-steel.png
...
Related Media:
- The Green Knight
*** [[https://www.thearcanelibrary.com/pages/shadowdark][Shadowdark]] :noexport:
{{{imgzoom}}}
...
- Conan
- The 13th Warrior
*** [[https://www.myth.works/en-gb/pages/slugblaster][Slugblaster]] :noexport:
{{{imgzoom}}}
...
*** [[https://sine-nomine-publishing.myshopify.com/collections/stars-without-number/products/stars-without-number-revised][Stars Without Number]]
